...
namespace Orchestrator.Infrastructure.Migrations
{
    ...
    [Migration("20260513091803_AddMcpIntegrations")]
    partial class AddMcpIntegrations
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Orchestrator.Core.Entities.AgentRegistration", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TenantId", "Capability");
            ...
            modelBuilder.Entity("Orchestrator.Core.Entities.ArtifactDepartment", b =>
                {
                    ...
                    b.HasKey("ArtifactId", "DepartmentId");

                    b.HasIndex("DepartmentId");

                    b.ToTable("ArtifactDepartments");
                });
            ...
            modelBuilder.Entity("Orchestrator.Core.Entities.DepartmentManifest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Orchestrator.Core.Entities.DepartmentManifest", b =>
                {
                    b.HasOne("Orchestrator.Core.Entities.Tenant", "Tenant")
                        .WithOne("DepartmentManifest")
                        .HasForeignKey("Orchestrator.Core.Entities.DepartmentManifest", "TenantId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Orchestrator.Core.Entities.Artifact", b =>
                {
                    b.Navigation("ArtifactDepartments");
            ...
            modelBuilder.Entity("Orchestrator.Core.Entities.Tenant", b =>
                {
                    b.Navigation("AgentRegistrations");
