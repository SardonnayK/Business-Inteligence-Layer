    ...
    <div className="flex h-screen overflow-hidden">
      ...
      <aside className="flex w-64 flex-shrink-0 flex-col bg-slate-900">
        ...
        <div className="flex h-16 items-center gap-2.5 px-6">
          ...
          <span className="text-sm font-semibold text-white">BI Orchestrator</span>
        </div>
        ...
        <nav className="flex-1 space-y-0.5 px-3 py-4">
          ...
          <NavLink to="/context" className={navClass}>
            <ContextIcon /> Business Context
          </NavLink>
          <NavLink to="/projects" className={navClass}>
            <ProjectsIcon /> Projects
          </NavLink>
          <NavLink to="/knowledge" className={navClass}>
            <KnowledgeIcon /> Knowledge
          </NavLink>
        ...
        <div className="border-t border-slate-800 px-4 py-3">
          {user && (
            <div className="mb-2 flex items-center gap-2">
              <div className="flex h-7 w-7 flex-shrink-0 items-center justify-center rounded-full bg-slate-700 text-xs font-medium text-white">
              ...
              <button
                onClick={logout}
                title="Sign out"
                className="flex-shrink-0 rounded p-1 text-slate-400 hover:bg-slate-700 hover:text-white"
              >
          ...
          <p className="text-xs text-slate-500">v0.0.1</p>
        </div>
      </aside>
